...
// Enter you own analog values here
float loadA = 1.076; // kg
int analogvalA = 862; // analog reading taken with load A on the load cell

float loadB = 0.29; // kg
int analogvalB = 390; // analog reading taken with load B on the load cell
